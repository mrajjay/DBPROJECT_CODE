...
public class BackendStarter {
	public static void main(String[] args) {
		...
		while(true)
		{
			System.out.println("Press 1 for student 2 for doctor and 3 for nurse");
			role=sc.nextInt();
			switch(role) {
			case 1: {System.out.println("Hello Student");StudentEntryPoint.StudentOperations();break;}
			case 2:{System.out.println("Hello Doctor");
